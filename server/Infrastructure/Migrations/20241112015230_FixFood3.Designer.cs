...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241112015230_FixFood3")]
    partial class FixFood3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.FoodImportRequestDetails", b =>
                {
                    ...
                    b.Property<string>("FoodImportRequests")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Core.Entities.FoodImportDetails", b =>
                {
                    ...
                    b.HasOne("Core.Entities.FoodImports", "FoodImport")
                    ...
                    b.Navigation("FoodImport");
                });

            modelBuilder.Entity("Core.Entities.FoodImportRequestDetails", b =>
                {
                    b.HasOne("Core.Entities.FoodImportRequests", "FoodImportRequest")
                        .WithMany("FoodImportRequestDetails")
                        .HasForeignKey("FoodImportRequests");
                    ...
                    b.Navigation("FoodImportRequest");
                });
